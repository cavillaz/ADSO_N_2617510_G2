...
<div class="pantalla">
  ...
  <script>
    ...
    function cerrarModal() {
      ...
      window.location.href = "usuarios.php"; // Redireccionar a index.html
    }

    // Función para mostrar el modal automáticamente al cargar la página
window.onload = function() {
    mostrarModal(); // Llama a la función para mostrar el modal al cargar
  }
  </script>
      <?php
    ...
    if ($resultado->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Identificación</th><th>Nombres</th><th>Correo</th><th>Torre</th><th>Apartamento</th><th>Celular</th><th>Seleccionar</th></tr>";
